...
class CropActivity : BaseActivity(), ICropView.Proxy {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        // Show/hide the enhance/rotation/save group (only after cropping or using original)
        ...
        // The "Use Original" button is visible only before cropping
        menu.findItem(R.id.use_original).isVisible = !showMenuItems
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.use_original -> {
                Log.e(TAG, "Use Original touched!")
                mPresenter.useOriginal()
                changeMenuVisibility(true) // now show save/enhance/rotate
                return true
            }
